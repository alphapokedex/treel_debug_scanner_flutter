...
class DeviceScanInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceScanInfo', createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'byteData', $pb.PbFieldType.OY, protoName: 'byteData')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $core.List<$core.int> get byteData => $_getN(7);
  @$pb.TagNumber(8)
  set byteData($core.List<$core.int> v) { $_setBytes(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasByteData() => $_has(7);
  @$pb.TagNumber(8)
  void clearByteData() => clearField(8);
}
