...
abstract class $DiscoveredDevice {
  ...
  @override
  String toString() =>
      "DiscoveredDevice(id: $id, name: $name, serviceData: $serviceData, serviceUuids: $serviceUuids, manufacturerData: $manufacturerData, byteData: $byteData, rssi: $rssi)";
  ...
  bool operator ==(Object other) =>
      ...
      const DeepCollectionEquality().equals(byteData, other.byteData) &&
      rssi == other.rssi;
  ...
  int get hashCode {
    ...
    result = 37 * result + const DeepCollectionEquality().hash(byteData);
...
class DiscoveredDevice$ {
  ...
  static final byteData = Lens<DiscoveredDevice, Uint8List>(
    (byteDataContainer) => byteDataContainer.byteData,
    (byteDataContainer, byteData) =>
        byteDataContainer.copyWith(byteData: byteData),
  );
